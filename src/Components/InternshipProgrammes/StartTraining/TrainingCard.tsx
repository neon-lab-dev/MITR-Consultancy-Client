...
const TrainingCard: React.FC<TTrainingCard> = ({ _id, poster, courseName, description, price, duration, isDescriptionVisible, isPriceVisible=true, imageHeight = "h-[215px]" }) => {
    return (
            ...
            <div className="px-2 pt-2 pb-5">
                <h1 className="text-neutral-45 font-semibold leading-[25px]">{courseName}</h1>
                {
                    ...
                    {/* <div className="flex items-center gap-2">
                        ...
                        <p className="text-neutral-25 font-semibold leading-5">₹{price}</p>
                    <div className="flex items-center gap-2">
