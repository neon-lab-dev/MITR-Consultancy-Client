...
const ProgrammeDetailsHero : React.FC<TProgrammeDetailsHero> = ({_id, poster, lessons, courseName, title, description, price, duration, totalEnrolled, rating}) => {
    return (
        <div className="font-Inter mt-20">
            ...
            {/* Content */}
            <Container>
                <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center xl:items-start justify-center flex-col text-center xl:text-start py-10 md:py-16 xl:py-24 2xl:py-5 w-full max-w-full xl:max-w-[1300px] mx-auto h-[470px] 2xl:h-fit px-5 md:px-7 2xl:px-0">
