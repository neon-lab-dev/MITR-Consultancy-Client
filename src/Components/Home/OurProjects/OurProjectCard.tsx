...
const OurProjectCard: React.FC<TOurProjectCard> = ({ image, projectName, description, liveLink }) => {
    return (
        <div className="bg-white rounded shadow-xl w-full md:w-full min-h-[644px] p-5 font-Inter flex flex-col justify-between">
            <Image src={image} alt={`MITRA Consultancy - ${projectName}`} className="h-[376px] w-full rounded object-cover" />
