...
const ProfileInfoCard = () => {
    return (
        <div className="absolute top-40 w-[328px] h-[500px] bg-white shadow-course-details rounded-2xl px-4 py-8">
            ...
            <p className="text-neutral-115 leading-6 text-center">Rahul Sutradhar</p>
