    ...
    sections: [
      {
        title: (
          <h1 className="text-black font-semibold">
            About{" "}
            <span className="text-secondary-20 text-2xl font-extrabold">ISO 27001</span>
          </h1>
        ),
        details: [
      ...
      {
        title: <h1 className="text-black font-semibold">Why do you need us?</h1>,
        details: [
    ...
    sections: [
      {
        title: (
          <h1 className="text-black font-semibold">
            About <span className="text-secondary-20 text-2xl font-extrabold">SOC2</span>
          </h1>
        ),
        details: [
    ...
    sections: [
      {
        title: (
          <h1 className="text-black font-semibold">
            About <span className="text-secondary-20 text-2xl font-extrabold">HIPAA</span>
          </h1>
        ),
        details: [
    ...
    sections: [
      {
        title: (
          <h1 className="text-black font-semibold">
            About <span className="text-secondary-20 text-2xl font-extrabold">GDPR</span>
          </h1>
        ),
        details: [
    ...
    sections: [
      {
        title: (
          <h1 className="text-black font-semibold">
            About <span className="text-secondary-20 text-2xl font-extrabold">DPDP’23</span>
          </h1>
        ),
        details: [
    ...
    sections: [
      {
        title: (
          <h1 className="text-black font-semibold">
            About <span className="text-secondary-20 text-2xl font-extrabold">GRP Automation</span>
          </h1>
        ),
        details: [
    ...
    sections: [
      {
        title: (
          <h1 className="text-black font-semibold">
            About <span className="text-secondary-20 text-2xl font-extrabold">PCI DSS</span>
          </h1>
        ),
        details: [
    ...
    sections: [
      {
        title: (
          <h1 className="text-black font-semibold">
            About <span className="text-secondary-20 text-2xl font-extrabold">CCPA</span>
          </h1>
        ),
        details: [
