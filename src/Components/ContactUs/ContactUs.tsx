                ...
                <div
                    ...
                    <div
                        ...
                        className={`${isContactUsModalOpen ? " scale-[1] opacity-100" : " scale-[0] opacity-0"
                            } w-full max-w-[1060px] h-full max-h-[90%] xl:max-h-[580px] overflow-y-auto md:overscroll-y-none bg-white rounded-2xl transition-all duration-300 mx-auto p-5 flex flex-col-reverse md:flex-row items-center gap-9 font-Inter
                            ${
