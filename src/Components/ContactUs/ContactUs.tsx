            ...
            <div onClick={(e) => e.stopPropagation()} className="">
                <div
                    ...
                    <div
                        ...
                        className={`${isContactUsModalOpen ? " scale-[1] opacity-100" : " scale-[0] opacity-0"
                            } w-full max-w-[1060px] h-full max-h-[90%] xl:max-h-[580px] overflow-y-auto bg-white rounded-2xl transition-all duration-300 mx-auto p-5 flex flex-col-reverse xl:flex-row items-center gap-9 font-Inter`}>
                        <div className="relative h-full w-full flex flex-col items-center justify-center">
                            ...
                            <div className="flex flex-col items-center justify-center w-full absolute top-0 bottom-0 right-0 left-0 z-20">
                                ...
                                <p className="text-white text-[10px] md:text-base leading-7 mt-4">Have questions or want to discuss your next big idea?</p>
                                <p className="text-white text-[10px] md:text-base leading-7 mt-[6px]">We're here to help you bring your digital vision to life.</p>
                            </div>
                        </div>
